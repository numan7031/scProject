...
$sql = "INSERT INTO restaurant (`resname`, `lat`, `lng`, `description`, `adress`, `phone`, `attracID`, `image`)";
$sql .="VALUES ";
$sql .="('".$_POST["textresname"]."','".$_POST["textLat"]."','".$_POST["textLong"]."','".$_POST["textDescription"]."','".$_POST["textadress"]."'
