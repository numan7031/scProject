...
<br>
  <form action="../../insertGalorySuv.php" method="post" enctype="multipart/form-data">
...
//this is were images displayed
            ...
            $sql3 = "SELECT * FROM `souvenirimages` WHERE servID = $_resgalid";
            $query3 = mysqli_query($con, $sql3);

           while($result3 = mysqli_fetch_assoc($query3)){
                    ?>
                  <a href="../../deleteGalorySuv.php?delete=<?php echo $result3['ID']?>" onclick = "return ConfirmDelete()"><img src="../.<?php echo $result3['imageURL']?>" id="AEDbutton"></a>
            <?php   }
