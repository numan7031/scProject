	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form name="form1" class="login100-form validate-form" enctype="multipart/form-data" method="post">
					<?php
					    $db=new mysqli('localhost','root','','scdb');
					    $db->query("SET NAMES UTF8");
							if (isset($_POST['id'])) {
    					// aksinya
    					$id = $_POST['id']; // sesuai dengan niali parameter.
					...
					<span class="login100-form-title">
						...
						<input type="hidden" name="iduser" value="<?php echo $all_row["attracID"];?>">
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="textUsername" id="textUsername" placeholder="Username" value="<?php echo $all_row["atname"];?>">
						<span class="focus-input100"></span>
					</div>

					<div>
						<input class="input100" type="text" name="textFirstName" id="textFirstName" placeholder="FirstName" value="<?php echo $all_row["typeAttraction"];?>">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="textLastName" id="textLastName" placeholder="LastName" value="<?php echo $all_row["adress"];?>">
						<span class="focus-input100"></span>
					</div>
				...
				<img src="<?php echo $all_row["image"];?>">
			</div>
			</div>
		</div>
	</div>
