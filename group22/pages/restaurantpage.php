...
<div class="container-fluid">
  <div class="row content">
    <div class="col-sm-8">
      ...
      $sql5 = "SELECT r.resname,r.image,r.description,r.adress,a.atname,r.lat,r.lng,r.phone FROM `restaurant` r JOIN attractions a ON r.attracID = a.attracID  WHERE resID  =  $_atid";
      ...
      <table>
        <tr>
          ...
          <tr><td>สถานที่ท่องเที่ยวใกล้เคียง</td>
            <td><?php echo $result5['atname']; ?></td></tr>
