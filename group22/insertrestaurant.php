...
<div class="limiter">
	<div class="container-login100">
		<div class="wrap-login100">
			...
			<form name="form1" method="post" enctype="multipart/form-data" action="AdminInsertRes.php">
...
<div class="container-login100-form-btn">
	<div class="wrap-input100 validate-input">
		<div class="wrap-input100 validate-input">
			<input class="input100" type="hidden" name="resID" id="resID">
		...
		<div>
			...
			<div class="wrap-input100 validate-input">
				...
				<div class="wrap-input100 validate-input">
					<input class="input100" type="text" name="textresname" id="textresname" placeholder="ชื่อร้านอาหาร">
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 validate-input">
