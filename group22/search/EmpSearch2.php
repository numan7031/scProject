    ...
    * {box-sizing: border-box}
    ...
    <body id="top">
      <header role="banner">
		...
		<ul class="pagination">
		<li>
		<a href="EmpSearch2.php?page=1" aria-label="Previous">
		<span aria-hidden="true">&laquo;</span>
		</a>
		</li>
		<?php for($i=1;$i<=$total_page;$i++){ ?>
		<li><a href="EmpSearch2.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
		<?php } ?>
		<li>
		<a href="EmpSearch2.php?page=<?php echo $total_page;?>" aria-label="Next">
