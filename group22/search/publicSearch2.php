...
<?php
  ...
  $sql = "SELECT * FROM restaurant ORDER BY resID ASC LIMIT $start ,$perpage";
...
<head>
    ...
    * {box-sizing: border-box}
					...
					<div class="row">
						<div class="col-md-offset-2 col-md-8">
							<div class="panel panel-default">
								<div class="panel-heading">ค้นหาร้านอาหาร</div>
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<input type="text" name="search-key" id="search-key" class="form-control" placeholder="โปรดกรอกชื่อร้านอาหารที่คุณต้องการค้นหา">
									</div>
    ...
    <?php
    $sql2 = "SELECT * FROM restaurant ORDER BY resID ASC";
    ...
    <ul class="pagination">
    <li>
    <a href="publicSearch2.php?page=1" aria-label="Previous">
    <span aria-hidden="true">&laquo;</span>
    </a>
    </li>
    <?php for($i=1;$i<=$total_page;$i++){ ?>
    <li><a href="publicSearch2.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
    <?php } ?>
    <li>
    <a href="publicSearch2.php?page=<?php echo $total_page;?>" aria-label="Next">
				...
				success:function(data){
					...
					$.each(data, function(key, post){
						$('.post-data-list').append('<div class="li-post-group">\
										<h4 class="li-post-title">'+post.resname+'</h4>\
