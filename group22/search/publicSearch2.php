                  ...
                  $sql = "SELECT * FROM restaurant ORDER BY resID DESC";
									...
									?>
										<div class="li-post-group">
											<h4 class="li-post-title"><?php echo ucfirst($row["resname"]); ?></h4>
                      ...
                      <p class="li-post-desc"><figcaption><a class="btn small" href="restaurant.php?id=<?php echo $row["resID"]; ?>">More</a></figcaption></p>
